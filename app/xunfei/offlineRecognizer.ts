export default class OfflineRecognizer {
    ...
    private _wordList = [["xi_li_jiang", "x i l i j i ang"], ["xiao_qian", "x i ao q i an"], ["ni_hao", "n i h ao"], ["ni_hao_ma", "n i h ao m a"], ["zai_jian", "z ai j ian"], ["huan_ying", "h uan y ing"], ["xie_xie", "x ie x ie"], ["ming_tian_jian", "m ing t ian j ian"]];
    private _wordListChinese = { "xi_li_jiang": "西莉酱", "xiao_qian": "小倩", "ni_hao": "你好", "ni_hao_ma": "你好吗", "zai_jian": "再见", "huan_ying": "欢迎", "xie_xie": "谢谢", "ming_tian_jian": "明天见" };
    private _grammarChineseGreetings = { numStates: 1, start: 0, end: 0, transitions: [{ from: 0, to: 0, word: "xi_li_jiang" }, { from: 0, to: 0, word: "xiao_qian" }, { from: 0, to: 0, word: "ni_hao" }, { from: 0, to: 0, word: "ni_hao_ma" }, { from: 0, to: 0, word: "zai_jian" }, { from: 0, to: 0, word: "huan_ying" }, { from: 0, to: 0, word: "xie_xie" }, { from: 0, to: 0, word: "ming_tian_jian" }] };
    private _grammars = [{ title: "Chinese Greetings", g: this._grammarChineseGreetings }];
    private _grammarIds: any[] = [];
